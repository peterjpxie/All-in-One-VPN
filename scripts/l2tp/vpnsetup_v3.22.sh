...
# replace 192.168.43.x with 192.168.41.x because 192.168.43.x is used as Android hotspot subnet. Not tested yet.
# XAUTH_NET=${VPN_XAUTH_NET:-'192.168.43.0/24'}
# XAUTH_POOL=${VPN_XAUTH_POOL:-'192.168.43.10-192.168.43.250'}
XAUTH_NET=${VPN_XAUTH_NET:-'192.168.41.0/24'}
XAUTH_POOL=${VPN_XAUTH_POOL:-'192.168.41.10-192.168.41.250'}
